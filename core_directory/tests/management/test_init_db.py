...
@pytest.mark.django_db
@mock.patch("core_directory.management.commands.init_db.Command.download_and_load_data")
...
@pytest.mark.django_db
@mock.patch("core_directory.management.commands.init_db.Github")
...
@pytest.mark.django_db
@mock.patch("core_directory.management.commands.init_db.Repo.clone_from")
@mock.patch("core_directory.management.commands.init_db.Command.get_repo_info")
@mock.patch("core_directory.management.commands.init_db.CoreSerializer")
...
@mock.patch("core_directory.management.commands.init_db.Repo.clone_from", side_effect=GitCommandError('clone', 1))
@mock.patch("core_directory.management.commands.init_db.Command.get_repo_info")
...
@pytest.mark.django_db
@mock.patch("core_directory.management.commands.init_db.Repo.clone_from", side_effect=OSError("filesystem error"))
@mock.patch("core_directory.management.commands.init_db.Command.get_repo_info")
